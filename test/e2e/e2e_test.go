/*
Copyright 2024 Mitja Kramberger.
...
import (
	...
	"github.com/mkramb/newrelic-synthetic-operator/test/utils"
)

// namespace where the project is deployed in
const namespace = "newrelic-synthetics-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "newrelic-synthetics-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "newrelic-synthetics-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "newrelic-synthetics-operator-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=newrelic-synthetics-operator-metrics-reader",
